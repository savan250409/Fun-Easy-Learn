    ...
    <div class="page-header-custom">
        ...
        <div class="d-flex align-items-center">
            <div class="stats-badge me-3">
                <i class="mdi mdi-layers"></i> Total: <span id="totalCount">{{ $categories->total() }}</span> Categories
            </div>
        ...
        <div class="card-body">
            <div class="custom-search-wrapper">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <input type="text" id="searchInput" class="search-input-box" placeholder="Search categories...">
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center px-4 py-3 border-top"
                ...
                <div id="showingText">Showing {{ $categories->firstItem() ?? 0 }} to {{ $categories->lastItem() ?? 0 }} of {{ $categories->total() }} entries</div>
                <div id="paginationWrapper">{{ $categories->links('pagination::bootstrap-4') }}</div>
            </div>
        </div>
    </div>
@endsection
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('tableBody').addEventListener('click', function (e) {
            ...
            Swal.fire({
                ...
                Swal.fire({
                    title: 'Warning!',
                    text: "This will also delete all related Subcategories, Child Categories, Items, and their images permanently. Proceed?",
                    icon: 'error',
                    showCancelButton: true,
                    confirmButtonColor: '#ff7b94',
                    cancelButtonColor: '#e2e6ea',
